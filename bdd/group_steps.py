...
@given(
    parse('a group with {name}, {header} and {footer}'),
    target_fixture='new_group'
)
...
@then(
    'the new group list is equal to the old list with the added group',
...
@then(
    'the new group list is equal to the old list without the deleted group',
      target_fixture='verify_group_deleted'
)
